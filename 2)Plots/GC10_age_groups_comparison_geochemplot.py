...
lns1 = ax[0].plot(data_temp.NOxconc*1000, data_temp.Depth, c='black', label = r'$NO_3^-$',linewidth=3,linestyle='dotted')
lns2 = ax[0].plot(data_temp.NH4conc*1000, data_temp.Depth, c='darkgreen', label = r'$NH_4^+$',linewidth=3,linestyle='dashed')
ax2 = ax[0].twiny()
