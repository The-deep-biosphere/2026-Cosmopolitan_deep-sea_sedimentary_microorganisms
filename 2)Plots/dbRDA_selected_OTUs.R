...
if (T){
  ...
  PCA_scores$site_colour[which(PCA_scores$site_colour == 'NWPO')] = 'blue'
  PCA_scores$site_colour[which(PCA_scores$site_colour == 'MAR')] = 'lightblue'
  PCA_scores$site_colour[which(PCA_scores$site_colour == 'WNAG')] = 'orange'  
  PCA_scores$site_colour[which(PCA_scores$site_colour == 'SPO')] = 'grey'  
}
# ----------
# PCA plot
# ----------
...
plt1 <-ggplot(PCA_scores, aes(x = V1, y = V2))+
  geom_point(aes(shape = Loc),alpha=0.05, size=2.8) +
