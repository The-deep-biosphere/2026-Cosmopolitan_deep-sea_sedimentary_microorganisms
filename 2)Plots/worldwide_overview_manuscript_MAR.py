...
size_dot = 50
f,(axs) = plt.subplots(1,4, gridspec_kw={'width_ratios':[0.2,0.2,0.2,1]})
...
axdepth.set_xticks(np.arange(0, max(depth)+500., 3000.))
...
plt.savefig(os.getcwd()+f'/overview_manuscript_{var}-sites_MAR.png', dpi=300)
