...
colour_label = {0:'AMOR',1:"Pacific",2:'Atlantic',3:'North Pond',4:'SCS'}
...
ax3.set_xlabel(f'NO$_3$ [µM]', fontsize = '25')
...
if var3 == 'oxygen':
    ax1.set_xlabel(f'O$_2$ [µM]', fontsize = '25')
    ax1.set_xlim(0,45)
...
plt.savefig(os.getcwd()+f'/overview_manuscript_{var}-sites_SCS.png', dpi=300)
