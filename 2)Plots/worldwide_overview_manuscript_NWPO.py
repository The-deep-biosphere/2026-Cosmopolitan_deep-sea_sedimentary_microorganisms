...
# select relevant features according to DT
# --------------------------------------------
...
X.columns = feature_names_family
...
size_dot = 50
f,(axs) = plt.subplots(1,5, gridspec_kw={'width_ratios':[0.2,0.2,0.2,0.2,1]})
...
plt.savefig(os.getcwd()+f'/overview_manuscript_{var}-sites_NWPO.png', dpi=300)
