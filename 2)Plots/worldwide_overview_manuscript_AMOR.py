...
dic_name = {'oxygen':'O2conc', 'nitrate':'NOxconc','manganese':'Mnconc','NH4':'NH4conc'}
...
axdepth.set_xticks(np.arange(0, max(depth)+50, 100.))
...
ax2.set_xlabel('Mn [µM]', fontsize = '25')
ax2.set_xlim(0,400)
ax2.set_xticks(np.arange(0, 400, 100.0))
...
if var3 == 'nitrate':
    ax1.set_xlabel(r'NO$_3$ [µM]', fontsize = '25')
    ax1.set_xlim(0,45)
    ax1.set_xticks(np.arange(0, 45, 20.0))
...
plt.savefig(os.getcwd()+f'/overview_manuscript_{var}-sites_AMOR.png', dpi=300)
